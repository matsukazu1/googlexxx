...
def hello():
    numbers = 0
    result = requests.get(f"https://www.google.co.jp/search?num=7&q=猫&source=lnt&tbs=lr:lang_1ja&lr=lang_ja&sa=X&ved=2ahUKEwi1mO2n4qvpAhVMHaYKHUhYBfMQpwV6BAgOEBk&biw=1536&bih=674")
